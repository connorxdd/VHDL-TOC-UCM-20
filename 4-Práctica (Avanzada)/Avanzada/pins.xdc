...
set_property PACKAGE_PIN N3 [get_ports {switched}]
	set_property IOSTANDARD LVCMOS33 [get_ports {switched}]
...
set_property PACKAGE_PIN U2 [get_ports {output_segments[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {output_segments[0]}]
set_property PACKAGE_PIN U4 [get_ports {output_segments[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {output_segments[1]}]
set_property PACKAGE_PIN V4 [get_ports {output_segments[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {output_segments[2]}]
set_property PACKAGE_PIN W4 [get_ports {output_segments[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {output_segments[3]}]
